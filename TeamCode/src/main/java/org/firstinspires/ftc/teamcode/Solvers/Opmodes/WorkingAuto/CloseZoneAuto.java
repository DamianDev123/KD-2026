...
public class CloseZoneAuto extends CommandOpMode {
    ...
    public PathChain toLaunch,toRow1,toRow1Intake,toLaunchZoneRow1,toRow2,toRow2Intake,toGate,toLaunchZoneRow2,toRow3,toRow3Intake,toLaunchZoneRow3,toPark;
    ...
    public void initialize() {
        ...
        SequentialCommandGroup autonomousSequence = new SequentialCommandGroup(
                ...
                new FollowPathCommand(follower,toLaunchZoneRow1,true),
                new InstantCommand(()-> robot.intake.intake(false)),
                new ShootBalls()
