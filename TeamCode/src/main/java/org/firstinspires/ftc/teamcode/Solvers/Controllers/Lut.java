...
public class Lut {
    ...
    private Lut(List<Double> x, List<Double> y, List<Double> m) {
        this(x, y, m, false);
    }

    private Lut(List<Double> x, List<Double> y, List<Double> m, boolean safeMode) {
        mX = x;
        mY = y;
        mM = m;
    ...
    public Lut(List<Double> input, List<Double> output) {
        this(input, output, false);
    }

    public Lut(List<Double> input, List<Double> output, boolean safeMode) {
     ...
     */
    public Lut add(double input, double output) {
        mX.add(input);
        mY.add(output);
    ...
    public Lut setSafeMode(boolean safeMode) {
        this.safeMode = safeMode;
        return this;
    }
